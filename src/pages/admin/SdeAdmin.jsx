...
import { 
  ...
  faServer, faFileImport, faDownload, faUpload,
  faLayerGroup, faCubes, faGlobe, faUsers, faBuilding, faShip,
  faChartPie, faHistory, faCloudDownloadAlt
        ...
        <Modal.Body>
          <Form>
            ...
            <Alert variant="warning">
              ...
              from the official CCP source, replacing the current version. The process may take several minutes.
            </Alert>
          </Form>
        </Modal.Body>
        <Modal.Footer>
