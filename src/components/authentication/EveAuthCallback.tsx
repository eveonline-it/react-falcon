...
import { EveAuthData, NavigationState } from './types';
...
const EveAuthCallback = () => {
  ...
  const location = useLocation() as { state?: NavigationState; pathname: string };
  const [processing, setProcessing] = useState(true);
  const [error, setError] = useState<string | null>(null);
  const [authData, setAuthData] = useState<EveAuthData | null>(null);
  ...
  useEffect(() => {
    ...
    const processAuthData = async (authData: EveAuthData) => {
