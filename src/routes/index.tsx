...
const Character = lazy(() => import('pages/user/Character'));
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              ...
              {
                path: paths.userCharacter,
                element: (
                  <Suspense key="user-character" fallback={<FalconLoader />}>
                    <Character />
                  </Suspense>
                )
              },
          ...
          },
          {
            ...
            children: [
              ...
              {
                path: paths.groupsAdmin,
                element: (
                  <Suspense key="groups-admin" fallback={<FalconLoader />}>
                    <GroupsAdmin />
                  </Suspense>
                )
              },
              {
                path: paths.usersAdmin,
                element: (
