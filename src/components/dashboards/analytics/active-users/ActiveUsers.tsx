...
import { activeUsersChart } from '../../../../data/dashboard/analytics.js';
...
interface ActiveUsersProps extends React.ComponentProps<typeof Card> {
  // Additional props if needed
}

const ActiveUsers: React.FC<ActiveUsersProps> = ({ ...rest }) => {
  const [stats] = useState<UserStat[]>([
    {
      label: 'Mobile',
      color: 'primary',
      value: 10325
