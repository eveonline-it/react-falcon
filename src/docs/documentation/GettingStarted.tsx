...
const serveCode = `npm run preview`;
  ...
  <>
      ...
      <Col lg={12} xxl={6}>
        <Card className="mb-3 border border-warning h-100">
          ...
          <Card.Body className="pb-0 position-relative">
            <SubtleBadge
              bg="warning"
              className="fs-10 py-2 opacity-85 fw-medium"
            >
              <FontAwesomeIcon
                className="me-2 fs-11 fw-medium"
                icon={faTrophy}
              />
              Hire us!
            </SubtleBadge>
    ...
    <Card className="mb-3">
      ...
      <Card.Body>
        ...
        <p>
          This will create an optimized production build by compiling, merging
