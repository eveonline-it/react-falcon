...
// Sample data to replace removed LMS data
const trendingKeywords = [
  { name: 'React', v: 95, color: '#007bff' },
  { name: 'JavaScript', v: 85, color: '#28a745' },
  { name: 'Node.js', v: 75, color: '#ffc107' },
  { name: 'TypeScript', v: 65, color: '#17a2b8' },
  { name: 'Vue', v: 55, color: '#6f42c1' },
  { name: 'Angular', v: 45, color: '#e83e8c' },
  { name: 'GraphQL', v: 35, color: '#fd7e14' },
  { name: 'MongoDB', v: 25, color: '#20c997' }
];
