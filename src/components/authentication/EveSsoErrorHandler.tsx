...
import { EveSsoErrorHandlerProps, EveErrorDetails } from './types';

/**
 * EVE SSO Error Handler Component
 * Handles different types of EVE Online SSO errors as per official documentation
 */
const EveSsoErrorHandler = ({ error, onRetry, onGoBack }: EveSsoErrorHandlerProps) => {
  // Parse error type and provide appropriate user guidance
  const getErrorDetails = (errorMessage: string): EveErrorDetails => {
